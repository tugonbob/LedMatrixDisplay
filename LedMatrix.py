...
'''
TODO:
- Fix rainbow_print/wheel (change print_str and align_str to function like it used to when a color is given as an argument or as it is when no color is given)
- Parallel processing to get stock info while other things are displaying (Read up on threading)
'''
